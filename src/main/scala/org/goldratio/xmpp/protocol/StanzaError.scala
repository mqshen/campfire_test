...
object StanzaError
{
    ...
    {
        import org.goldratio.xmpp.protocol.StanzaErrorCondition._
        ...
        new StanzaError(Elem(null, tag, attributes, TopScope, children:_*))
    }
...
object StanzaErrorCondition extends Enumeration
{
    ...
    protected case class Condition(name:String, action:StanzaErrorAction.Value, legacyCode:Int) extends Val(name)
